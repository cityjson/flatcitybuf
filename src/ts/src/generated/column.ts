...
static addType(builder:flatbuffers.Builder, type:ColumnType) {
  builder.addFieldInt8(2, type, ColumnType.Byte);
}
...
static createColumn(builder:flatbuffers.Builder, index:number, nameOffset:flatbuffers.Offset, type:ColumnType, titleOffset:flatbuffers.Offset, descriptionOffset:flatbuffers.Offset, precision:number, scale:number, nullable:boolean, unique:boolean, primaryKey:boolean, metadataOffset:flatbuffers.Offset):flatbuffers.Offset {
  Column.startColumn(builder);
  Column.addIndex(builder, index);
