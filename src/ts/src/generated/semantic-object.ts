...
import { SemanticSurfaceType } from './semantic-surface-type.js';
...
static addExtensionType(builder:flatbuffers.Builder, extensionTypeOffset:flatbuffers.Offset) {
  builder.addFieldOffset(4, extensionTypeOffset, 0);
}
...
static createSemanticObject(builder:flatbuffers.Builder, type:SemanticSurfaceType, attributesOffset:flatbuffers.Offset, childrenOffset:flatbuffers.Offset, parent:number|null, extensionTypeOffset:flatbuffers.Offset):flatbuffers.Offset {
  ...
  SemanticObject.addExtensionType(builder, extensionTypeOffset);
