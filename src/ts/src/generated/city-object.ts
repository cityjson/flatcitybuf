...
import { CityObjectType } from './city-object-type.js';
import { Column } from './column.js';
import { GeographicalExtent } from './geographical-extent.js';
import { Geometry } from './geometry.js';
import { GeometryInstance } from './geometry-instance.js';
...
extensionType(optionalEncoding:flatbuffers.Encoding):string|Uint8Array|null
extensionType(optionalEncoding?:any):string|Uint8Array|null {
...
geometryInstances(index: number, obj?:GeometryInstance):GeometryInstance|null {
  const offset = this.bb!.__offset(this.bb_pos, 14);
  return offset ? (obj || new GeometryInstance()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
}

geometryInstancesLength():number {
  const offset = this.bb!.__offset(this.bb_pos, 14);
  return offset ? this.bb!.__vector_len(this.bb_pos + offset) : 0;
}
...
static addExtensionType(builder:flatbuffers.Builder, extensionTypeOffset:flatbuffers.Offset) {
  builder.addFieldOffset(1, extensionTypeOffset, 0);
}
...
static addGeometryInstances(builder:flatbuffers.Builder, geometryInstancesOffset:flatbuffers.Offset) {
  builder.addFieldOffset(5, geometryInstancesOffset, 0);
}

static createGeometryInstancesVector(builder:flatbuffers.Builder, data:flatbuffers.Offset[]):flatbuffers.Offset {
  builder.startVector(4, data.length, 4);
  for (let i = data.length - 1; i >= 0; i--) {
    builder.addOffset(data[i]!);
  }
...
static startGeometryInstancesVector(builder:flatbuffers.Builder, numElems:number) {
  builder.startVector(4, numElems, 4);
}
...
static addChildrenRoles(builder:flatbuffers.Builder, childrenRolesOffset:flatbuffers.Offset) {
  builder.addFieldOffset(9, childrenRolesOffset, 0);
}
...
static addParents(builder:flatbuffers.Builder, parentsOffset:flatbuffers.Offset) {
  builder.addFieldOffset(10, parentsOffset, 0);
}
