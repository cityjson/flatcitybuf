...
import { DoubleVertex } from './double-vertex.js';
import { Extension } from './extension.js';
import { GeographicalExtent } from './geographical-extent.js';
import { Geometry } from './geometry.js';
import { ReferenceSystem } from './reference-system.js';
...
appearance(obj?:Appearance):Appearance|null {
  const offset = this.bb!.__offset(this.bb_pos, 6);
  return offset ? (obj || new Appearance()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!) : null;
}
...
semanticColumns(index: number, obj?:Column):Column|null {
  const offset = this.bb!.__offset(this.bb_pos, 10);
  return offset ? (obj || new Column()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
}

semanticColumnsLength():number {
  const offset = this.bb!.__offset(this.bb_pos, 10);
  return offset ? this.bb!.__vector_len(this.bb_pos + offset) : 0;
}
...
attributeIndex(index: number, obj?:AttributeIndex):AttributeIndex|null {
  const offset = this.bb!.__offset(this.bb_pos, 16);
  return offset ? (obj || new AttributeIndex()).__init(this.bb!.__vector(this.bb_pos + offset) + index * 16, this.bb!) : null;
}

attributeIndexLength():number {
  const offset = this.bb!.__offset(this.bb_pos, 16);
  return offset ? this.bb!.__vector_len(this.bb_pos + offset) : 0;
}
...
templates(index: number, obj?:Geometry):Geometry|null {
...
templatesVertices(index: number, obj?:DoubleVertex):DoubleVertex|null {
  const offset = this.bb!.__offset(this.bb_pos, 30);
  return offset ? (obj || new DoubleVertex()).__init(this.bb!.__vector(this.bb_pos + offset) + index * 24, this.bb!) : null;
}

templatesVerticesLength():number {
  const offset = this.bb!.__offset(this.bb_pos, 30);
  return offset ? this.bb!.__vector_len(this.bb_pos + offset) : 0;
}

extensions(index: number, obj?:Extension):Extension|null {
  const offset = this.bb!.__offset(this.bb_pos, 32);
  return offset ? (obj || new Extension()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
}
...
static addAppearance(builder:flatbuffers.Builder, appearanceOffset:flatbuffers.Offset) {
  builder.addFieldOffset(1, appearanceOffset, 0);
}
...
static addSemanticColumns(builder:flatbuffers.Builder, semanticColumnsOffset:flatbuffers.Offset) {
  builder.addFieldOffset(3, semanticColumnsOffset, 0);
}

static createSemanticColumnsVector(builder:flatbuffers.Builder, data:flatbuffers.Offset[]):flatbuffers.Offset {
  builder.startVector(4, data.length, 4);
  for (let i = data.length - 1; i >= 0; i--) {
    builder.addOffset(data[i]!);
  }
...
static startSemanticColumnsVector(builder:flatbuffers.Builder, numElems:number) {
  builder.startVector(4, numElems, 4);
}

static addFeaturesCount(builder:flatbuffers.Builder, featuresCount:bigint) {
  builder.addFieldInt64(4, featuresCount, BigInt('0'));
}
...
static addAttributeIndex(builder:flatbuffers.Builder, attributeIndexOffset:flatbuffers.Offset) {
  builder.addFieldOffset(6, attributeIndexOffset, 0);
}

static startAttributeIndexVector(builder:flatbuffers.Builder, numElems:number) {
...
static addTemplates(builder:flatbuffers.Builder, templatesOffset:flatbuffers.Offset) {
  builder.addFieldOffset(12, templatesOffset, 0);
}
...
static addTemplatesVertices(builder:flatbuffers.Builder, templatesVerticesOffset:flatbuffers.Offset) {
  builder.addFieldOffset(13, templatesVerticesOffset, 0);
}

static startTemplatesVerticesVector(builder:flatbuffers.Builder, numElems:number) {
  builder.startVector(24, numElems, 8);
}

static addExtensions(builder:flatbuffers.Builder, extensionsOffset:flatbuffers.Offset) {
  builder.addFieldOffset(14, extensionsOffset, 0);
}
...
static addVersion(builder:flatbuffers.Builder, versionOffset:flatbuffers.Offset) {
  builder.addFieldOffset(27, versionOffset, 0);
}

static endHeader(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  builder.requiredField(offset, 58) // version
  return offset;
}
