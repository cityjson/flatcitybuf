...
import { GeometryType } from './geometry-type.js';
import { MaterialMapping } from './material-mapping.js';
import { SemanticObject } from './semantic-object.js';
import { TextureMapping } from './texture-mapping.js';
...
material(index: number, obj?:MaterialMapping):MaterialMapping|null {
  const offset = this.bb!.__offset(this.bb_pos, 22);
  return offset ? (obj || new MaterialMapping()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
}
...
texture(index: number, obj?:TextureMapping):TextureMapping|null {
  const offset = this.bb!.__offset(this.bb_pos, 24);
  return offset ? (obj || new TextureMapping()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
}
...
static addMaterial(builder:flatbuffers.Builder, materialOffset:flatbuffers.Offset) {
  builder.addFieldOffset(9, materialOffset, 0);
}
...
static addTexture(builder:flatbuffers.Builder, textureOffset:flatbuffers.Offset) {
  builder.addFieldOffset(10, textureOffset, 0);
}

static createTextureVector(builder:flatbuffers.Builder, data:flatbuffers.Offset[]):flatbuffers.Offset {
  builder.startVector(4, data.length, 4);
  for (let i = data.length - 1; i >= 0; i--) {
    builder.addOffset(data[i]!);
  }
...
static startTextureVector(builder:flatbuffers.Builder, numElems:number) {
  builder.startVector(4, numElems, 4);
}
...
static createGeometry(builder:flatbuffers.Builder, type:GeometryType, lodOffset:flatbuffers.Offset, solidsOffset:flatbuffers.Offset, shellsOffset:flatbuffers.Offset, surfacesOffset:flatbuffers.Offset, stringsOffset:flatbuffers.Offset, boundariesOffset:flatbuffers.Offset, semanticsOffset:flatbuffers.Offset, semanticsObjectsOffset:flatbuffers.Offset, materialOffset:flatbuffers.Offset, textureOffset:flatbuffers.Offset):flatbuffers.Offset {
  ...
  Geometry.addMaterial(builder, materialOffset);
  Geometry.addTexture(builder, textureOffset);
