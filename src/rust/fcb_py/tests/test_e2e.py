...
import pytest
import fcb
from fcb import Reader, AsyncReader, BBox, AttrFilter, FcbError
...
class TestE2EIntegration:
    ...
    def test_file_exists(self):
        ...
        assert os.path.exists(self.small_fcb_path), f"Test file not found: {self.small_fcb_path}"
        assert os.path.exists(self.delft_fcb_path), f"Test file not found: {self.delft_fcb_path}"
    ...
    def test_spatial_query_bbox(self):
        ...
        features = reader.query_bbox(bbox.min_x, bbox.min_y, bbox.max_x, bbox.max_y)
    ...
    def test_convenience_functions(self):
        ...
        if os.path.exists(self.delft_bbox_fcb_path):
            bbox_features = fcb.query_bbox(
                self.delft_bbox_fcb_path, 
                85000, 446000, 86000, 447000
            )
