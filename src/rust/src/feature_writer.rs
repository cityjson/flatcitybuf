// use crate::feature_generated::flat_city_buf::{
//     CityFeature, CityFeature, CityFeatureArgs, CityFeatureArgs, CityFeatureBuilder,
//     CityFeatureOffset, CityObject, CityObjectArgs, CityObjectType, Geometry, GeometryArgs,
//     GeometryType, SemanticObject, SemanticSurfaceType,
// };
// use crate::header_generated::flat_city_buf::{Column, ColumnArgs, ColumnOffset};
// use byteorder::{ByteOrder, LittleEndian};
// use cjseq::{Appearance, CityJSON, CityJSONFeature, CityObject, Geometry, Geometry, Transform};
...
//     pub fn new(// dataset_type: GeometryType,
//         // detect_type: bool,
//         // promote_to_multi: bool,
//     ) -> FeatureWriter<'a> {
//         FeatureWriter {
...
//             )
//         };
//         let properties = Some(self.fbb.create_vector(&self.attributes));
//         self.attributes.truncate(0);
...
//         let ofs = self.attributes.len();
//         self.attributes
//             .resize(ofs + size_of::<u16>() + prop_size(colval), 0);
//         LittleEndian::write_u16(&mut self.attributes[ofs..], i as u16);
//         let prop = &mut self.attributes[ofs + size_of::<u16>()..];
//         match colval {
