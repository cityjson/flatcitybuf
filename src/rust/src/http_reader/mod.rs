...
use crate::packedrtree::{HttpRange, HttpSearchResultItem, NodeItem, PackedRTree};
use crate::reader::city_buffer::FcbBuffer;
use crate::{
    check_magic_bytes, size_prefixed_root_as_city_feature, HEADER_MAX_BUFFER_SIZE, HEADER_SIZE_SIZE,
};
use crate::{header_generated::*, MAGIC_BYTES_SIZE};
...
pub struct HttpFcbReader<T: AsyncHttpRangeClient = reqwest::Client> {
