// Entry in a B-tree node
//
// This module defines the Entry struct which represents a key-value pair in a B-tree node.
// Entries are the fundamental units of data stored in the B-tree, consisting of a fixed-width
