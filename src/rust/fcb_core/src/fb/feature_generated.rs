...
impl<'a> CityObject<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.geometry_instances { builder.add_geometry_instances(x); }
  ...
  #[inline]
  pub fn geometry_instances(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<GeometryInstance<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<GeometryInstance>>>>(CityObject::VT_GEOMETRY_INSTANCES, None)}
  }
  #[inline]
...
impl flatbuffers::Verifiable for CityObject<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<GeometryInstance>>>>("geometry_instances", Self::VT_GEOMETRY_INSTANCES, false)?
...
pub struct CityObjectArgs<'a> {
    ...
    pub geometry_instances: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<GeometryInstance<'a>>>>>,
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> CityObjectBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_geometry_instances(&mut self, geometry_instances: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<GeometryInstance<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(CityObject::VT_GEOMETRY_INSTANCES, geometry_instances);
  }
  #[inline]
