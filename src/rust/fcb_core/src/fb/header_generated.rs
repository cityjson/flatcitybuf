...
impl<'a> Header<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.templates_verteces { builder.add_templates_verteces(x); }
  ...
  pub fn templates_verteces(&self) -> Option<flatbuffers::Vector<'a, DoubleVertex>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, DoubleVertex>>>(Header::VT_TEMPLATES_VERTECES, None)}
  }
  #[inline]
...
impl flatbuffers::Verifiable for Header<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, DoubleVertex>>>("templates_verteces", Self::VT_TEMPLATES_VERTECES, false)?
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> HeaderBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_templates_verteces(&mut self, templates_verteces: flatbuffers::WIPOffset<flatbuffers::Vector<'b , DoubleVertex>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Header::VT_TEMPLATES_VERTECES, templates_verteces);
  }
  #[inline]
