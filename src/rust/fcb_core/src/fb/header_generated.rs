...
impl<'b> flatbuffers::Push for AttributeIndex {
    ...
    #[inline]
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = ::core::slice::from_raw_parts(self as *const AttributeIndex as *const u8, Self::size());
        dst.copy_from_slice(src);
    }
}
...
impl<'b> flatbuffers::Push for DoubleVertex {
    ...
    #[inline]
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = ::core::slice::from_raw_parts(self as *const DoubleVertex as *const u8, Self::size());
        dst.copy_from_slice(src);
    }
}
...
impl<'a> Header<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.templates_vertices { builder.add_templates_vertices(x); }
    ...
    if let Some(x) = args.attribute_index { builder.add_attribute_index(x); }
  ...
  pub fn appearance(&self) -> Option<Appearance<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<Appearance>>(Header::VT_APPEARANCE, None)}
  }
  #[inline]
  ...
  pub fn attribute_index(&self) -> Option<flatbuffers::Vector<'a, AttributeIndex>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, AttributeIndex>>>(Header::VT_ATTRIBUTE_INDEX, None)}
  }
  #[inline]
  ...
  #[inline]
  pub fn templates(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Geometry<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Geometry>>>>(Header::VT_TEMPLATES, None)}
  }
  #[inline]
  pub fn templates_vertices(&self) -> Option<flatbuffers::Vector<'a, DoubleVertex>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, DoubleVertex>>>(Header::VT_TEMPLATES_VERTICES, None)}
  }
  #[inline]
  pub fn extensions(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Extension<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Extension>>>>(Header::VT_EXTENSIONS, None)}
  }
  #[inline]
...
impl flatbuffers::Verifiable for Header<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, AttributeIndex>>>("attribute_index", Self::VT_ATTRIBUTE_INDEX, false)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("title", Self::VT_TITLE, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Geometry>>>>("templates", Self::VT_TEMPLATES, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, DoubleVertex>>>("templates_vertices", Self::VT_TEMPLATES_VERTICES, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Extension>>>>("extensions", Self::VT_EXTENSIONS, false)?
...
pub struct HeaderArgs<'a> {
    ...
    pub title: Option<flatbuffers::WIPOffset<&'a str>>,
    pub templates: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Geometry<'a>>>>>,
    pub templates_vertices: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, DoubleVertex>>>,
    pub extensions: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Extension<'a>>>>>,
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> HeaderBuilder<'a, 'b, A> {
  ...
  pub fn add_appearance(&mut self, appearance: flatbuffers::WIPOffset<Appearance<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Appearance>>(Header::VT_APPEARANCE, appearance);
  }
  #[inline]
  ...
  #[inline]
  pub fn add_attribute_index(&mut self, attribute_index: flatbuffers::WIPOffset<flatbuffers::Vector<'b , AttributeIndex>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Header::VT_ATTRIBUTE_INDEX, attribute_index);
  }
  #[inline]
  ...
  #[inline]
  pub fn add_templates(&mut self, templates: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Geometry<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Header::VT_TEMPLATES, templates);
  }
  #[inline]
  pub fn add_templates_vertices(&mut self, templates_vertices: flatbuffers::WIPOffset<flatbuffers::Vector<'b , DoubleVertex>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Header::VT_TEMPLATES_VERTICES, templates_vertices);
  }
  #[inline]
  pub fn add_extensions(&mut self, extensions: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Extension<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Header::VT_EXTENSIONS, extensions);
  }
  #[inline]
