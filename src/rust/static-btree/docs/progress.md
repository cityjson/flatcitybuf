...
1. Add handling payloads and duplicates in the tree
2. Add more comprehensive unit tests for payload and duplicate scenarios
3. Prototype `http_stream_query` using packed_rtree's client abstraction
