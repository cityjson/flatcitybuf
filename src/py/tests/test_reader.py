...
class TestIntegration:
    ...
    @pytest.mark.skip(reason="Requires test FCB file")
    def test_read_actual_file(self):
        """Test reading an actual FCB file"""
        # This would require a test FCB file
        reader = Reader("test_data/sample.fcb")
        info = reader.info()
        ...
        # Test spatial query
        bbox_features = reader.query_bbox(0, 0, 1000, 1000)
