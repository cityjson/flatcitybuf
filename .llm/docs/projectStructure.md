...
│   ├── rust.md                     # Rust guide (reference implementation: reader, writer, CLI)
│   ├── cpp.md                      # C++ guide (native reader + writer)
│   ├── py.md                       # Python guide (pure-Python reader)
│   ├── ts.md                       # TypeScript guide (native reader for browser + Node.js)
│   ├── TESTING.md                  # Full manual verification procedure, local and remote
...
│
├── 📁 conformance/                  # Shared conformance corpus for all four implementations
